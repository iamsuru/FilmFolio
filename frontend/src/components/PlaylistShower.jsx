...
const PlaylistShower = () => {
    ...
    useEffect(() => {
        const getPrivacy = async () => {
            try {
                const response = await fetch(`/api/playlist/privacy?ref=${user.uid}&name=${playlistName}`)
        ...
        const getPlaylist = async () => {
            try {
                const response = await fetch(`/api/shared/my-playlist?ref=${user.uid}&name=${playlistName}`);
                const data = await response.json();
                if (response.ok) {
    ...
    const setPrivacyHandler = async () => {
        setLoading(true);
        try {
            const response = await fetch(`/api/playlist/privacy`, {
                method: 'POST',
                headers: {
